...
private let log = Logger(subsystem: "com.Matt.Pfeiffer.SwiftPitchEffect.PitchEffectExtension", category: "AudioUnitViewController")

public class AudioUnitViewController: AUViewController, AUAudioUnitFactory {
    var audioUnit: AUAudioUnit?
    
    var hostingController: HostingController<PitchEffectExtensionMainView>?
	...
	*/
    ...
    public func createAudioUnit(with componentDescription: AudioComponentDescription) throws -> AUAudioUnit {
        audioUnit = try PitchEffectAudioUnit(componentDescription: componentDescription, options: []) //PitchEffectExtensionAudioUnit(componentDescription: componentDescription, options: [])
        
        guard let audioUnit = self.audioUnit as? PitchEffectAudioUnit else {
            log.error("Unable to create PitchEffectAudioUnit")
            return audioUnit!
        }
...
//        audioUnit.setupParameterTree(PitchEffectExtensionParameterSpecs.createAUParameterTree())
    ...
    private func configureSwiftUIView(audioUnit: AUAudioUnit) {
        ...
        let content = PitchEffectExtensionMainView(parameterTree: observableParameterTree)
