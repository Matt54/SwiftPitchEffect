//
//  PitchEffectExtensionAUProcessHelper.hpp
...
#include <vector>
#include "PitchEffectExtensionDSPKernel.hpp"

//MARK:- AUProcessHelper Utility Class
class AUProcessHelper
{
public:
    AUProcessHelper(PitchEffectExtensionDSPKernel& kernel)
    : mKernel{kernel} {}
...
private:
    PitchEffectExtensionDSPKernel& mKernel;
};
